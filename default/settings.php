...
// Acquia deploy git config for deployment to acquia cloud.
$git_path = trim(shell_exec('which git'));
$git_path = empty($git_path) ? 'git' : $git_path;
$conf['acquia_deploy_git_bin'] = $git_path;
$conf['acquia_deploy_git_config'] = array(
  'pull' => array(
    array(
      'uri' => 'git@github.com:CBNewMedia/uwe_drupal_7.git',
      'branch' => 'master',
      'src_dir' => '/',
      'dest_dir' => '/docroot',
    ),
    array(
      'uri' => 'git@github.com:CBNewMedia/cbstatewatch.git',
      'branch' => 'master',
      'src_dir' => '/',
      'dest_dir' => '/docroot/sites',
    ),
  ),
  'push' => array(
    'uri' => 'cbstatewatch@svn-15689.prod.hosting.acquia.com:cbstatewatch.git',
    'branch' => 'master',
  ),
);
 ...
 * $_ENV['AH_SITE_ENVIRONMENT'] variable.
 */
...
switch ($env) {
  ...
  case 'dev':
    ...
    // Acquia deploy settings.
    $conf['acquia_deploy_git_config']['pull'][0]['uri'] = 'https://github.com/CBNewMedia/uwe_drupal_7.git';
    $conf['acquia_deploy_git_config']['pull'][1]['uri'] = 'https://github.com/CBNewMedia/cbstatewatch.git';
    break;
...
// MEMCACHE Configuration for Drupal 7.
//if ($env != 'local' && extension_loaded('memcache') && file_exists('profiles/uwe_profile/modules/contrib/memcache/memcache.inc')) {
//  $conf['cache_backends'][] = 'profiles/uwe_profile/modules/contrib/memcache/memcache.inc';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/cbstatewatch/cbstatewatch-settings.inc');
}
